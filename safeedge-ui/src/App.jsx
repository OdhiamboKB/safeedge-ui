...
// ── INCIDENT DATA ────────────────────────────────────
// Lifted out of JSX into a data array — mirrors how
// SafeEdge will eventually fetch this from the Flask API
const INCIDENTS = [
  {
    id: 'INC-2026-047',
  ...
  },
  {
    ...
    rootCause: 'Immediate cause: battery overfilled during top-up. Area isolated and ventilated. Spill neutralised with sodium bicarbonate. PPE check confirmed — no injuries.',
  },
]
...
// Concept: component receives props + calls parent handler
...
// ── APP ROOT ─────────────────────────────────────────
// Concept: filter state lives here — affects which cards render
function App() {
  const [activeFilter, setActiveFilter] = useState('All')

  // Derived data — filter incidents based on activeFilter state
  ...
  return (
    <div style={{ background: '#f5f2eb', minHeight: '100vh', padding: '48px 24px', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        {/* Filter bar — state lifted to App */}
